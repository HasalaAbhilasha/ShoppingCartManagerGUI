        ...
        switch (productType){
            case 1:
                for (int i = 0; i < shoppingCart.getProductList().size(); i++) {
                    if(productToDelete.equals(shoppingCart.getProductList().get(i).getProductId()) && shoppingCart.getProductList().get(i).getProductType().equals("clothing")){
            ...
            case 2:
                for (int i = 0; i < shoppingCart.getProductList().size(); i++) {
                    if(productToDelete.equals(shoppingCart.getProductList().get(i).getProductId()) && shoppingCart.getProductList().get(i).getProductType().equals("electronic")){
                        shoppingCart.getProductList().get(i).displayProducts();
                        shoppingCart.removeProduct(shoppingCart.getProductList().get(i));
                        System.out.println("Item deleted successfully");
                        System.out.println("Items Left in the Cart : " + shoppingCart.getProductList().size());
